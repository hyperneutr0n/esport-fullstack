...
$totalEventTeam = count($teamEvents);
...
$eventTeamDisplayed = array_slice($teamEvents, $offset, $rowCount);

function DisplayTable($teamEvents)
{
    foreach ($teamEvents as $teamEvent) { ?>

        <?php $idevent = $teamEvent["idevent"]; ?>
